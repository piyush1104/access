module github.com/piyush1104/access

go 1.18

require (
	github.com/100mslive/auth v0.0.0-20220510141733-b65f737de1b4
...
require (
	github.com/100mslive/go-grpc v0.0.0-20211107203337-954e2d121d42 // indirect
